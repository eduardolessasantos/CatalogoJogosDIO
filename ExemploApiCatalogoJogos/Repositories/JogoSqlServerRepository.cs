...
namespace ExemploApiCatalogoJogos.Repositories
{
    public class JogoSqlServerRepository : IJogoRepository
    {
        ...
        public async Task<List<Jogo>> Obter(int pagina, int quantidade)
        {
            ...
            while (sqlDataReader.Read())
            {
                jogos.Add(new Jogo
                {
                    ...
                    Preco = (double)(decimal)sqlDataReader["Preco"],
                    Genero = (int)sqlDataReader["Genero"]
                });
            }
        ...
        {
            var comando = $"insert Jogos (Id, Nome, Produtora, Preco, Genero) values ('{jogo.Id}', '{jogo.Nome}', '{jogo.Produtora}', {jogo.Preco.ToString().Replace(",", ".")}, '{jogo.Genero}')";
        ...
        {
            var comando = $"update Jogos set Nome = '{jogo.Nome}', Produtora = '{jogo.Produtora}', Preco = {jogo.Preco.ToString().Replace(",", ".")}, Genero = '{jogo.Genero}' where Id = '{jogo.Id}'";
